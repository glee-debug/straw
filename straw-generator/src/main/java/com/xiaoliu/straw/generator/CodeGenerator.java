package com.xiaoliu.straw.generator;
...
public class CodeGenerator {
    ...
    public static String url = "jdbc:mysql://localhost:3308/usermanagment?characterEncoding=utf8&useSSL=false&serverTimezone=Asia/Shanghai&rewriteBatchedStatements=true";
    public static String username="root";
    public static String password="root";
    //父级别包名称
    public static String parentPackage = "cn.bonc.ccib";
    //代码生成的目标路径
    ...
    //作者名
    public static String author = "xiaoliu";
    //模块名称，用于组成包名
    public static String modelName = "ccib";
